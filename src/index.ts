...
export type {
    ...
    SaveSmallLanguageModelCheckpointOptions,
    SmallLanguageModel,
    SmallLanguageModelCheckpointMetadata,
    SmallLanguageModelCheckpointVariable,
    SmallLanguageModelEpochMetrics,
    SmallLanguageModelEvaluationMetrics,
    SmallLanguageModelEvaluationOptions,
    SmallLanguageModelGenerationStep,
    SmallLanguageModelGenerationOptions,
    SmallLanguageModelLayer,
    SmallLanguageModelOptions,
    SmallLanguageModelTextGenerationResult,
    SmallLanguageModelTextGenerationTokenizer,
    SmallLanguageModelTrainingBatchOrder,
