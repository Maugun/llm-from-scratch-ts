...
console.info('2. Créer le tokenizer à partir de ce texte')
console.info('3. Encoder le texte pour créer le dataset')
console.info('')
console.info(`Fichier lu: ${corpusPath}`)
console.info('')
console.info('Contenu du fichier:')
console.info(rawText)
console.info(`Caractères dans le texte brut: ${String(rawText.length)}`)
...
console.info('')
console.info('Ces mêmes ids décodés:')
